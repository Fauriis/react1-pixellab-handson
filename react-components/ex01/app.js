...
console.warn(
  'Folosind map pe arrayul friends, returneaza un array in care fiecare pozitie contine propozitia Ma numesc name surname si am age ani',
);
...
console.warn(
  'Folosind map pe arrayul friends, returneaza un array in care fiecare pozitie contine propozitia Diferenta de varsa dintre {friendName} si {personName} este {diff}',
);
